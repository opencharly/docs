...
*The compiler is documented in [README.md](https://github.com/opencharly/charly#readme); the house rules in [CLAUDE.md](https://github.com/opencharly/charly/blob/main/CLAUDE.md); every candy and box has a recipe card in the [opencharly/marketplace](https://github.com/opencharly/marketplace) repo's README — all of it published, and generated rather than retyped, at [opencharly.ai](https://opencharly.ai). Dated history lives — and only lives — in each repo's [CHANGELOG/](https://github.com/opencharly/charly/tree/main/CHANGELOG), one file per CalVer version.*
