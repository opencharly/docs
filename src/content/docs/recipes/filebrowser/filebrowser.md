---
title: "filebrowser"
description: "FileBrowser Quantum web file manager with Tailscale tunnel."
---
...
- [`/charly-filebrowser:filebrowser`](/recipes/filebrowser/filebrowser/) -- FileBrowser Quantum service, config, volumes
- [`/charly-distros:agent-forwarding`](/recipes/distros/agent-forwarding/) -- SSH/GPG agent forwarding
- [`/charly-infrastructure:dbus-layer`](/recipes/infrastructure/dbus-layer/) -- D-Bus session bus
- [`/charly-tools:charly`](/recipes/tools/charly/) -- charly CLI for in-container management

## Related Boxes

- [`/charly-distros:fedora`](/recipes/distros/fedora/) -- parent base image
- [`/charly-ollama:ollama`](/recipes/ollama/ollama/) -- similar simple service pattern
...
- [`/charly-filebrowser:filebrowser`](/recipes/filebrowser/filebrowser/) — candy authoring
- [`/charly-check:check`](/recipes/check/check/) — declarative testing framework
- [`/charly-core:charly-config`](/recipes/core/charly-config/) — deploy-mode setup with volume backing and tunnels
- [`/charly-build:build`](/recipes/build/build/) — LABELs-at-end cache efficiency
