---
title: "gocryptfs"
description: "Encrypted filesystem (gocryptfs) for charly config encrypted volume operations."
---
...
See [`/charly-automation:enc`](/recipes/automation/enc/) for full encrypted volume operations documentation.
...
- [`/charly-infrastructure:virtualization`](/recipes/infrastructure/virtualization/) -- part of the `charly` candy alongside gocryptfs
- [`/charly-infrastructure:socat`](/recipes/infrastructure/socat/) -- part of the `charly` candy alongside gocryptfs
