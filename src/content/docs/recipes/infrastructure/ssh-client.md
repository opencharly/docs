---
title: "ssh-client"
description: "OpenSSH client tools for SSH agent forwarding."
---
...
- [`/charly-coder:sshd`](/recipes/coder/sshd/) -- SSH server + client (includes systemd service, port 22)
- [`/charly-coder:gh`](/recipes/coder/gh/) -- GitHub CLI + git (uses SSH for git operations)
