---
title: "dbus-layer"
description: "D-Bus session bus for inter-process communication inside containers."
---
...
`charly check live <image> --filter dbus`. See [`/charly-check:dbus`](/recipes/check/dbus/) for the full
...
- [`/charly-selkies:sway`](/recipes/selkies/sway/) -- primary consumer (Sway depends on dbus)
- [`/charly-selkies:swaync`](/recipes/selkies/swaync/) -- notification daemon (depends on dbus)
- [`/charly-selkies:libnotify`](/recipes/selkies/libnotify/) -- `notify-send` CLI tool (depends on dbus)

## Related Commands

- [`/charly-check:dbus`](/recipes/check/dbus/) — the declarative `dbus:` check verb (notify, list, call, introspect), served out-of-process by `candy/plugin-dbus`
