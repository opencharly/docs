---
title: "supervisord"
description: "Supervisord process manager for running multiple services inside containers."
---
...
See [`/charly-selkies:chrome`](/recipes/selkies/chrome/) (Chrome supervision) and [`/charly-image:layer`](/recipes/image/layer/) (Security
...
See [`/charly-check:check`](/recipes/check/check/) Authoring Gotcha #4.
...
- [`/charly-languages:python`](/recipes/languages/python/) -- Optional pixi-python env (NOT a dep of this candy; supervisord uses system python3 from RPM)
- [`/charly-selkies:selkies-core`](/recipes/selkies/selkies-core/) -- owns the supervised `[program:chrome]` service (`restart: always`, `start_secs`/`start_retries`) for both selkies flavors
- [`/charly-selkies:chrome`](/recipes/selkies/chrome/) -- the chrome candy's cgroup resource caps (bound a Chrome crash loop's blast radius)
- [`/charly-infrastructure:traefik`](/recipes/infrastructure/traefik/) -- Reverse proxy (depends on supervisord)
- [`/charly-infrastructure:dbus-layer`](/recipes/infrastructure/dbus-layer/) -- D-Bus session bus (depends on supervisord)
- [`/charly-ollama:ollama`](/recipes/ollama/ollama/), [`/charly-openclaw:openclaw`](/recipes/openclaw/openclaw/), [`/charly-infrastructure:postgresql`](/recipes/infrastructure/postgresql/), [`/charly-infrastructure:redis`](/recipes/infrastructure/redis/), [`/charly-selkies:sway`](/recipes/selkies/sway/) -- All ship `service:` blocks

## Related Commands

- [`/charly-core:service`](/recipes/core/service/) — Start/stop/restart/status for individual services inside the container
- [`/charly-core:logs`](/recipes/core/logs/) — Container-level log access (shows supervisord-aggregated stdout/stderr)
- [`/charly-core:charly-status`](/recipes/core/charly-status/) — Container status including service probe results
- [`/charly-build:generate`](/recipes/build/generate/) — Containerfile generation: where `service:` blocks get written to `/etc/supervisord.conf`
- [`/charly-image:layer`](/recipes/image/layer/) — `service:` field authoring + `security:` cgroup resource caps
