---
title: "vectorchord"
description: "VectorChord PostgreSQL extension for optimized vector similarity search."
---
...
the AUR (see [`/charly-infrastructure:postgresql`](/recipes/infrastructure/postgresql/)).
...
- [`/charly-infrastructure:postgresql`](/recipes/infrastructure/postgresql/) -- required dependency (provides PostgreSQL server and pgvector)
- [`/charly-immich:immich`](/recipes/immich/immich/) -- primary consumer (migration script creates the extension)
