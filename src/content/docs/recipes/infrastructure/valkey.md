---
title: "valkey"
description: "Valkey 9.x key-value store (Redis-compatible) on port 6379 via Remi modular repo."
---
...
- [`/charly-infrastructure:redis`](/recipes/infrastructure/redis/) -- Redis alternative (same port 6379)

## Used In Boxes

- [`/charly-distros:valkey-test`](/recipes/distros/valkey-test/) (disabled box)
