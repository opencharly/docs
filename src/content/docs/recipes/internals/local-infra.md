---
title: "local-infra"
description: "Go file map for the host side of `local:` + VM deploy execution — deploy_chain.go, sshconfig, hostdistro, install_ledger, builder_run, reverse_ops, deploy_ref."
---
