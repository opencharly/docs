---
title: "git-workflow"
description: "Use when committing, branching, pushing, opening PRs, or landing a change with gh — the feat/-branch, R10-gated, PR-ONLY, org-workflow-validated, never-force-push landing across the main repo, its box submodules, the marketplace repo, and the proxy-resolved sdk contract module (no submodule — consumed at the pinned go.mod require)."
---
