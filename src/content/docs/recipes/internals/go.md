---
title: "go"
description: "Go CLI development: building the charly binary, running tests, source structure, and the SDD operationalization (spec/schema/*.cue -> `charly task cue-gen`)."
---
...
single-path `bin/charly` note is above and in [`/charly-tools:charly`](/recipes/tools/charly/).
