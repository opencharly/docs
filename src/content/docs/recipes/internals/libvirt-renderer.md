...
description: "Translation facade from VmSpec + LibvirtDomain to libvirt domain XML and QEMU argv — RenderDomainXML, device emission (passt, portForward, virtio-gpu), firmware plumbing, LibvirtDomain schema."
---
