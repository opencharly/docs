---
title: "agents"
description: "Multi-agent support across harnesses (Claude Code, Codex, Kimi) — sub-agents, dynamic workflows, agent teams, fresh validator sessions, and how each drives the `charly check` disposable beds."
---
