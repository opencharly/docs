---
title: "agents — program-discipline"
...
Companion reference for [`/charly-internals:agents`](/recipes/internals/agents/). Owns the instruments
...
[`/charly-internals:plugin`](/recipes/internals/plugin/)) would have caught it before a single teammate
ran.
...
agent — never another single-item patch.** [`/charly-internals:skills`](/recipes/internals/skills/)
...
- Entry: `../SKILL.md`
- [`references/orchestration-model.md`](/recipes/internals/agents/orchestration-model/) — the topology these instruments
  align.
