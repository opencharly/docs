---
title: "agents — hooks-and-lifecycle"
...
Companion reference for [`/charly-internals:agents`](/recipes/internals/agents/). Owns the hooks
...
[`/charly-internals:cutover-policy`](/recipes/internals/cutover-policy/)) — the autonomous loop never stops for
...
(the same rule [`/charly-internals:git-workflow`](/recipes/internals/git-workflow/) B7 states for the commit
...
consent, never rulebook prose. See [`/charly-internals:git-workflow`](/recipes/internals/git-workflow/) B5.
...
See [`references/agent-roster.md`](/recipes/internals/agents/agent-roster/) "Agent teams" for the team primitive's
...
- **Independent parallel sessions own their own worktree lifecycle.** A
  ...
  branch) after its own PR lands — [`/charly-internals:git-workflow`](/recipes/internals/git-workflow/) B1 step 0
...
- Entry: `../SKILL.md`
- [`references/orchestration-model.md`](/recipes/internals/agents/orchestration-model/) — the topology this discipline
  supports.
- [`references/parallel-bed-testing.md`](/recipes/internals/agents/parallel-bed-testing/) — the binding rule for running a
  bed, per-worktree self-freeze.
- [`references/agent-roster.md`](/recipes/internals/agents/agent-roster/) — the roster, the shipped workflows, the
  team primitive.
