---
title: "agents — orchestration-model"
...
Companion reference for [`/charly-internals:agents`](/recipes/internals/agents/). Owns the default
...
(all owned elsewhere in this skill and in [`/charly-internals:git-workflow`](/recipes/internals/git-workflow/))
...
[`references/parallel-bed-testing.md`](/recipes/internals/agents/parallel-bed-testing/) for the partition contract), multiple
...
- **Validators and design-reserve agents are transient/recyclable.** Stop a
  ...
  hygiene" in [`references/hooks-and-lifecycle.md`](/recipes/internals/agents/hooks-and-lifecycle/)).
...
[`/charly-internals:git-workflow`](/recipes/internals/git-workflow/) ("Concurrent landings"). The orchestrator
...
"Verify every delegate decision" ([`references/hooks-and-lifecycle.md`](/recipes/internals/agents/hooks-and-lifecycle/)) is
...
[`/charly-internals:plugin`](/recipes/internals/plugin/) (the placement table and the incomplete-seam
catalog).
...
- Owns: architectural integrity (every placement judged against the
  ...
  Law, [`/charly-internals:cutover-policy`](/recipes/internals/cutover-policy/): every non-blocking fix is routed
...
remove after landing ([`/charly-internals:git-workflow`](/recipes/internals/git-workflow/) B1 step 0 + B4
...
- Entry: `../SKILL.md`
- [`references/program-discipline.md`](/recipes/internals/agents/program-discipline/) — north-star protocol, IOU register,
  per-merge measurement, migration-ledger discipline.
- [`references/agent-roster.md`](/recipes/internals/agents/agent-roster/) — the primitives, the roster, the shipped
  workflows.
- [`references/parallel-bed-testing.md`](/recipes/internals/agents/parallel-bed-testing/) — the bed-scoped partition contract
  this model schedules against.
- [`references/hooks-and-lifecycle.md`](/recipes/internals/agents/hooks-and-lifecycle/) — delegation, teammate context
