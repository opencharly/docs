...
description: "R1 mandatory failure analysis agent."
---
...
- [`/charly-internals:strict-policy`](/recipes/internals/strict-policy/) — R1 mandate and forbidden-rationalization rules
- [`/charly-internals:agents`](/recipes/internals/agents/) — agent roster and conventions
- [`/charly-internals:cutover-policy`](/recipes/internals/cutover-policy/) — how RCA findings feed into cutovers
