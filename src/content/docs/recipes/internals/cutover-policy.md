...
- [`/charly-internals:install-plan`](/recipes/internals/install-plan/) — shared IR that survived the cutover unchanged (non-example — additive extension of the deploy-target surface)
