---
title: "remove"
description: "Remove service container, quadlet file, and charly.yml entry."
---
...
- [`/charly-core:stop`](/recipes/core/stop/) -- Stop without removing
- [`/charly-core:charly-config`](/recipes/core/charly-config/) -- Configure/reconfigure services (see "Full instance removal" for the teardown semantics)
- [`/charly-core:deploy`](/recipes/core/deploy/) -- Deploy.yml management, tunnel configuration
- [`/charly-core:service`](/recipes/core/service/) -- Full service lifecycle
- [`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) -- after `charly config remove` cleans this instance's `mcp_provide` from the global `provides.mcp:` list, consumers' `CHARLY_MCP_SERVERS` no longer lists it; use `charly check live <consumer> --filter mcp` to confirm the cleanup propagated
