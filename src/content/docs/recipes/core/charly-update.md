---
title: "charly-update"
description: "Update image and restart service with data sync — `charly update`, pulling new image versions, data seeding, force-seed, or updating deployed services."
---
...
(retention: `defaults.keep_images`, see [`/charly-core:clean`](/recipes/core/clean/)). To roll back:
...
- [`/charly-core:charly-config`](/recipes/core/charly-config/) -- initial deployment setup
- [`/charly-core:start`](/recipes/core/start/) -- start a service
- [`/charly-build:build`](/recipes/build/build/) -- building images locally
- [`/charly-core:charly-status`](/recipes/core/charly-status/) -- check service status after update
