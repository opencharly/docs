---
title: "cmd"
description: "Single command execution in a running container with D-Bus notification."
---
...
- [`/charly-core:shell`](/recipes/core/shell/) -- Interactive shell sessions with workspace mounts
- [`/charly-check:dbus`](/recipes/check/dbus/) -- D-Bus interaction inside containers
- [`/charly-automation:tmux`](/recipes/automation/tmux/) -- Typed persistent terminal sessions for long-running commands
