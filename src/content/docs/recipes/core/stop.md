---
title: "stop"
description: "Stop a running service container — `charly stop`, stopping containers, halting services."
---
...
- [`/charly-core:start`](/recipes/core/start/) -- Start services
- [`/charly-core:remove`](/recipes/core/remove/) -- Remove containers, quadlets, and deploy config
