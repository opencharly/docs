---
title: "charly-status"
description: "Service status display with tool probes and device detection — `charly status`, checking container state, tool availability, port mapping, or JSON status output."
---
...
- [`/charly-core:stop`](/recipes/core/stop/) -- stop a service (via [`/charly-core:service`](/recipes/core/service/))
