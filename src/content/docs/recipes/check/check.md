...
|---|---|---|
| Disposable beds, R10 acceptance gate | [`references/beds-and-r10.md`](/recipes/check/check/beds-and-r10/) | The bed roster, the "R10 gate by change class" matrix (sole owner), the 10 Testing Standards, "Flag discipline" (sole owner), exit codes, the three primary modes, wall-clock/timing data |
