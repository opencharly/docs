---
title: "jetkvm"
description: "The `jetkvm:` check/control verb (declarative, dispatched to the out-of-process plugin candy/plugin-jetkvm) — drive a JetKVM IP-KVM without a browser over its own WebRTC control plane: screenshots, OCR screen-reading, keyboard/mouse input, ATX/DC power, virtual media, USB gadget, device configuration, and a CONFIGURABLE console-installer driver for a `kind: jetkvm` device."
---
