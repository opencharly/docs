---
title: "check-sway-browser-vnc"
description: "The DISPOSABLE pod bed (check-sway-browser-vnc-pod) for R10 testing of the Sway desktop verb surface (cdp / wl / vnc / dbus / mcp / record)."
---
...
destroy + rebuild the bed unattended (see [`/charly-internals:disposable`](/recipes/internals/disposable/)). The bed
...
image-name; see [`/charly-core:deploy`](/recipes/core/deploy/)). Because this bed's key
...
- [`/charly-selkies:sway-browser-vnc`](/recipes/selkies/sway-browser-vnc/) — the shipping image this bed deploys
- [`/charly-check:check`](/recipes/check/check/) — the check framework + the disposable test-bed table
- [`/charly-check:cdp`](/recipes/check/cdp/), [`/charly-check:wl`](/recipes/check/wl/), [`/charly-check:vnc`](/recipes/check/vnc/), [`/charly-check:dbus`](/recipes/check/dbus/), [`/charly-check:record`](/recipes/check/record/),
  [`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) — the live-container verbs this bed covers
- [`/charly-core:deploy`](/recipes/core/deploy/) — `disposable:` bed semantics, the deploy-key vs image-name caveat
- [`/charly-internals:disposable`](/recipes/internals/disposable/) — the `disposable: true` authorization model
