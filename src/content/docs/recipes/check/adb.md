---
title: "adb"
description: "The `adb:` check verb (declarative, dispatched to the out-of-process plugin candy/plugin-adb) — Android Debug Bridge interaction, APK install/uninstall, device shell, system properties, screencap, logcat tailing."
---
