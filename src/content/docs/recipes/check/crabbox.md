---
title: "crabbox"
description: "the `crabbox:` check verb — probe the Crabbox CLI or its local coordinator (version/providers/config/doctor, coordinator health/ready via /v1/health and /v1/ready, and broker-backed leases/usage/events/logs), served out-of-process by plugin-crabbox."
---
...
Install the CLI with [`/charly-tools:crabbox`](/recipes/tools/crabbox/) (opencharly/layer-crabbox)
and the coordinator with [`/charly-crabbox:crabbox-coordinator`](/recipes/crabbox/crabbox-coordinator/)
