---
title: "punktfunk"
description: "the `punktfunk:` check verb — probe AND manage a running punktfunk streaming host over its management REST API (health, status, diagnostics, compositors, gpus, pairing, clients, library, virtual displays, plugins, hooks, actions, and a bounded SSE event subscription), served out-of-process by plugin-punktfunk."
---
...
Install the host itself with [`/charly-punktfunk:punktfunk-host`](/recipes/punktfunk/punktfunk-host/).
...
- [`/charly-punktfunk:punktfunk-host`](/recipes/punktfunk/punktfunk-host/) — the candy that installs the host
