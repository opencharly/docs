---
title: "android"
description: "The `kind: android` schema kind, a `target: android` deploy (the external deploy:android substrate), the `apk:` layer package format, the android deploy preresolver, an in-pod emulator OR a remote/physical adb-endpoint device, or nested pod-to-android deployment."
---
