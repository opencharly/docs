...
description: "LLMs on Supercomputers course notebook collection (TU Wien AI Factory Austria)."
---
...
The same `importlib.reload(ollama)` pattern from [`/charly-jupyter:notebook-ollama`](/recipes/jupyter/notebook-ollama/) is applied to all cleanup cells that use `import ollama` for model unloading.
...
- [`/charly-jupyter:notebook-finetuning`](/recipes/jupyter/notebook-finetuning/) — sibling data candy (Unsloth fine-tuning notebooks)
- [`/charly-jupyter:notebook-ollama`](/recipes/jupyter/notebook-ollama/) — sibling data candy (Ollama API tutorials)
- [`/charly-jupyter:notebook-templates`](/recipes/jupyter/notebook-templates/) — sibling data candy (starter notebooks)
- [`/charly-ollama:ollama`](/recipes/ollama/ollama/) — the Ollama server box (must be running for D0-D2 notebooks)
