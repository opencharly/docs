---
title: "jupyter"
description: "Lightweight JupyterLab with real-time collaboration on port 8888."
---
...
[`/charly-jupyter:jupyter`](/recipes/jupyter/jupyter/) for the package matrix.

## Key Candies

- [`/charly-jupyter:jupyter`](/recipes/jupyter/jupyter/) — JupyterLab + collaboration + data science
- [`/charly-distros:agent-forwarding`](/recipes/distros/agent-forwarding/) — SSH/GPG forwarding

## Related Boxes

- [`/charly-jupyter:jupyter-ml`](/recipes/jupyter/jupyter-ml/) — GPU-accelerated variant (nvidia base, full ML stack)
- [`/charly-jupyter:jupyter-ml-notebook`](/recipes/jupyter/jupyter-ml-notebook/) — GPU variant with fine-tuning notebooks
- [`/charly-openwebui:openwebui`](/recipes/openwebui/openwebui/) — Open WebUI consumes jupyter for code execution and MCP tools
- [`/charly-hermes:hermes`](/recipes/hermes/hermes/) — Hermes agent consumes jupyter MCP for notebook manipulation
...
files on disk AND drive jupyter via MCP. (See [`/charly-core:deploy`](/recipes/core/deploy/) for the
...
See [`/charly-jupyter:jupyter-mcp`](/recipes/jupyter/jupyter-mcp/) "Usage philosophy and caveats" for the full design principles + caveats. See [`/charly-jupyter:jupyter`](/recipes/jupyter/jupyter/) for full parameter and return type documentation.
...
See [`/charly-check:check`](/recipes/check/check/) for the framework and author-facing gotchas.

## Related Skills

- [`/charly-jupyter:jupyter`](/recipes/jupyter/jupyter/), [`/charly-jupyter:jupyter-mcp`](/recipes/jupyter/jupyter-mcp/), [`/charly-jupyter:notebook-templates`](/recipes/jupyter/notebook-templates/)
- [`/charly-check:check`](/recipes/check/check/) — declarative testing framework
- [`/charly-core:charly-config`](/recipes/core/charly-config/) — deploy setup
- [`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) — the box inherits 3 `context: [deploy]` `mcp:` scenario steps from the `jupyter` candy (`ping`, `list-tools` asserting all 11 prefixed tool names, `call notebook_list`). Run `charly check live jupyter --filter mcp` to exercise them against a live deployment
- [`/charly-jupyter:jupyter-ml`](/recipes/jupyter/jupyter-ml/), [`/charly-jupyter:jupyter-ml-notebook`](/recipes/jupyter/jupyter-ml-notebook/) — GPU variants that inherit the same MCP test suite
