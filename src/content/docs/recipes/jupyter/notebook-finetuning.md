...
description: "Unsloth fine-tuning notebook collection provisioned into the workspace volume at deploy time."
---
...
- [`/charly-jupyter:unsloth-studio`](/recipes/jupyter/unsloth-studio/)
...
- [`/charly-core:deploy`](/recipes/core/deploy/) -- volume backing configuration (bind, named, encrypted)
- [`/charly-jupyter:unsloth-studio`](/recipes/jupyter/unsloth-studio/) -- the Tier 2 meta-layer that owns the workspace volume
- [`/charly-jupyter:notebook-templates`](/recipes/jupyter/notebook-templates/) -- sibling data candy pattern (starter notebooks for jupyter)
- [`/charly-jupyter:unsloth-studio`](/recipes/jupyter/unsloth-studio/) -- the box that includes this candy
