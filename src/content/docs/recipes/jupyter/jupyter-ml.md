...
- **CRDT MCP Server** at `/mcp` — 11 tools for programmatic notebook access (server manages CRDT rooms invisibly; see [`/charly-jupyter:jupyter-mcp`](/recipes/jupyter/jupyter-mcp/) for the auto-attach + canonicalization design)
