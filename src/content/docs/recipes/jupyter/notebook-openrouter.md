...
description: "OpenRouter API integration notebook collection provisioned into the workspace volume at deploy time."
---
...
- [`/charly-image:layer`](/recipes/image/layer/) — data field documentation, env_require/env_accept field documentation
- [`/charly-core:charly-config`](/recipes/core/charly-config/) — data provisioning and env_require warning during `charly config` setup
- [`/charly-core:deploy`](/recipes/core/deploy/) — volume backing configuration
- [`/charly-jupyter:notebook-ollama`](/recipes/jupyter/notebook-ollama/) — sibling data candy pattern (Ollama integration notebooks)
...
- [`/charly-jupyter:notebook-llm-on-supercomputers`](/recipes/jupyter/notebook-llm-on-supercomputers/) — sibling data candy pattern (TU Wien course notebooks)
