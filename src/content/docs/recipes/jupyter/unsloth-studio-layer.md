---
title: "unsloth-studio-layer"
description: "Unsloth Studio fine-tuning web UI on ports 8888/8000 with vLLM inference."
---
...
- [`/charly-jupyter:unsloth`](/recipes/jupyter/unsloth/) — Sub-candy: vLLM + unsloth pip install + patch
- [`/charly-infrastructure:supervisord`](/recipes/infrastructure/supervisord/) — Process manager dependency
- [`/charly-jupyter:jupyter-ml`](/recipes/jupyter/jupyter-ml/) — Alternative: ML Jupyter with MCP (same Tier 1 sub-candies)
- [`/charly-languages:python-ml`](/recipes/languages/python-ml/) — Alternative: core ML without UI
