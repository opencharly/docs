...
- [`/charly-jupyter:jupyter-mcp`](/recipes/jupyter/jupyter-mcp/) -- MCP server implementation (sub-candy, 11 tools for programmatic notebook access using `<noun>_<verb>` naming; clients don't manage CRDT rooms — the server auto-attaches)
