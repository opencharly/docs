...
- [`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) — "Authoring tools" table exposing `candy.set`, `candy.add-rpm`, `candy.add-deb`, `candy.add-pac`, `candy.add-aur` as MCP tools; end-to-end build-from-scratch worked example.
