---
title: "alias"
description: "MUST be invoked before any work involving: host command aliases, charly alias add/remove/install/uninstall, or wrapper scripts that run inside containers."
---
...
- [`/charly-core:shell`](/recipes/core/shell/) -- How aliases execute commands via `charly shell -c`
- [`/charly-image:layer`](/recipes/image/layer/) -- Declaring aliases in charly.yml
- [`/charly-image:image`](/recipes/image/image/) -- Box-level alias overrides
