---
title: "herdr"
description: "The compiled-in ‘charly herdr’ CLI + the `herdr:` check verb for a Herdr terminal-multiplexer session (herdr.dev)."
---
...
- [`/charly-automation:herdr-box`](/recipes/automation/herdr-box/) — the herdr stack box + check-herdr-pod bed (pod-herdr repo).
