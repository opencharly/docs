---
title: "udev"
description: "MUST be invoked before any work involving: GPU device access rules, charly udev commands, udev rule management, or container GPU troubleshooting."
---
...
- [`/charly-core:charly-doctor`](/recipes/core/charly-doctor/) — hardware detection and dependency checks (includes GPU)
- [`/charly-distros:nvidia`](/recipes/distros/nvidia/) — NVIDIA GPU runtime candy
- [`/charly-distros:rocm`](/recipes/distros/rocm/) — AMD ROCm GPU compute candy
- [`/charly-distros:cuda`](/recipes/distros/cuda/) — CUDA toolkit candy
