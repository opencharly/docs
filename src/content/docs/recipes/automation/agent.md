---
title: "agent"
description: "Operate and diagnose Charly's daemon-free agent control plane, including sessions, runs, terminal channels, Pi native/orchestrator/TUI modes, tmux compatibility, federation, generic local/deployment/SSH/gRPC routes, transient Charly endpoint replication, incidents, RCA, and recovery."
---
...
- [`/charly-automation:tmux`](/recipes/automation/tmux/) — terminal-provider and compatibility details.
- [`/charly-check:check`](/recipes/check/check/) — full R10 workflow.
- [`/charly-internals:go`](/recipes/internals/go/) — provider placement and generated wire contracts.
- [`/charly-internals:root-cause-analyzer`](/recipes/internals/root-cause-analyzer/) — mandatory failure analysis.
