...
description: "Desktop video recorder via selkies WebSocket capture bridge for selkies-desktop."
---
...
- [`/charly-check:record`](/recipes/check/record/) -- the `record:` check verb (`record_mode: desktop`) auto-detects pixelflux-record
- [`/charly-core:charly-update`](/recipes/core/charly-update/) -- Per-instance update pattern used to roll out the per-frame `cleanup_texture_cache()` fix across live instances
- [`/charly-selkies:wl-screenshot-pixelflux`](/recipes/selkies/wl-screenshot-pixelflux/) -- Screenshot companion (same capture bridge, same singleton)
- [`/charly-selkies:wf-recorder`](/recipes/selkies/wf-recorder/) -- Alternative for sway-desktop (wlr-screencopy)
- [`/charly-selkies:selkies`](/recipes/selkies/selkies/) -- Parent candy (provides capture bridge, WebSocket stream, and the ScreenCapture singleton — see Pixelflux Memory Management)
- [`/charly-selkies:selkies-desktop-layer`](/recipes/selkies/selkies-desktop-layer/) -- Metalayer that composes this recorder into the full browser-accessible desktop
- [`/charly-selkies:ffmpeg`](/recipes/selkies/ffmpeg/) -- Required dependency (MP4 muxing)
