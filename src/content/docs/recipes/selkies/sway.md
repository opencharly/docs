---
title: "sway"
description: "Sway Wayland compositor running headless inside containers with Mesa GPU drivers."
---
...
Sway reads `XKB_DEFAULT_LAYOUT` natively from the environment — no wrapper change needed. See [`/charly-selkies:labwc`](/recipes/selkies/labwc/) for full XKB var list (MODEL, OPTIONS).
...
X11 tools for interacting with XWayland windows (`xdotool`, `xprop`, `xwininfo`, `import`) are provided by the [`/charly-selkies:wl-tools`](/recipes/selkies/wl-tools/) candy.
...
- [`/charly-selkies:chrome-sway`](/recipes/selkies/chrome-sway/) -- Chrome on Sway (depends on sway)
- [`/charly-selkies:sway-desktop`](/recipes/selkies/sway-desktop/) -- full desktop composition (VNC)
- [`/charly-selkies:wayvnc`](/recipes/selkies/wayvnc/) -- VNC access to Sway display
- [`/charly-selkies:waybar`](/recipes/selkies/waybar/) -- status bar (depends on sway)

## Related Commands

- [`/charly-check:wl`](/recipes/check/wl/) — Wayland desktop automation (screenshot, input, windows, clipboard, AT-SPI2)
