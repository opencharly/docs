...
description: "Screenshot via selkies WebSocket capture bridge for selkies-desktop."
---
...
- [`/charly-check:wl`](/recipes/check/wl/) — the `wl: screenshot` method auto-detects pixelflux-screenshot
- [`/charly-selkies:wl-record-pixelflux`](/recipes/selkies/wl-record-pixelflux/) — Recording companion (same capture bridge + same singleton)
- [`/charly-selkies:wl-screenshot-grim`](/recipes/selkies/wl-screenshot-grim/) — Alternative for sway-desktop (wlr-screencopy)
- [`/charly-selkies:selkies`](/recipes/selkies/selkies/) — Parent candy providing the ScreenCapture singleton and capture bridge
- [`/charly-selkies:selkies-desktop-layer`](/recipes/selkies/selkies-desktop-layer/) — Metalayer that composes this screenshot path into the selkies-labwc box
- [`/charly-check:record`](/recipes/check/record/) — Uses [`/charly-selkies:wl-record-pixelflux`](/recipes/selkies/wl-record-pixelflux/) via the same singleton
