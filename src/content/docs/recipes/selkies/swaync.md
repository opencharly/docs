---
title: "swaync"
description: "SwayNotificationCenter notification daemon for wlroots compositors (sway, labwc)."
---
...
- [`/charly-selkies:sway-desktop`](/recipes/selkies/sway-desktop/) -- via metalayer composition
- [`/charly-selkies:selkies-desktop-layer`](/recipes/selkies/selkies-desktop-layer/) -- via metalayer composition
...
- [`/charly-infrastructure:dbus-layer`](/recipes/infrastructure/dbus-layer/) -- D-Bus session bus dependency
- [`/charly-selkies:libnotify`](/recipes/selkies/libnotify/) -- `notify-send` CLI (optional; the `dbus: notify` check verb uses `gdbus` instead)
- [`/charly-selkies:waybar`](/recipes/selkies/waybar/) -- notification bell module
- [`/charly-selkies:waybar-labwc`](/recipes/selkies/waybar-labwc/) -- same notification bell module
- [`/charly-selkies:desktop-fonts`](/recipes/selkies/desktop-fonts/) -- Nerd Font icons for notification bell
