---
title: "kde-selkies"
description: "The KDE nested-compositor PRIMITIVE for the selkies streaming desktop — startplasma-wayland nested in pixelflux, de-SDDM, started by a supervisord poll-for-wayland-1 service."
---
...
- **Chrome:** this session script does NOT launch Chrome. The supervised
  ...
  ([`/charly-selkies:selkies-core`](/recipes/selkies/selkies-core/) "Chrome supervision", `restart: always`) owns it for
...
- [`/charly-selkies:labwc`](/recipes/selkies/labwc/) — the other nested-compositor primitive (the labwc seam).
- [`/charly-selkies:kde-shell`](/recipes/selkies/kde-shell/) — the SDDM-free Plasma session packages kde-selkies requires.
- [`/charly-selkies:selkies-kde-desktop`](/recipes/selkies/selkies-kde-desktop/) — the flavor metalayer composing this.
- [`/charly-distros:cachyos`](/recipes/distros/cachyos/) — CachyOS/Arch base where the KDE Plasma stack lives.
