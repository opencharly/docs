---
title: "xdg-portal"
description: "XDG Desktop Portal infrastructure for Sway containers — the portal daemon, the wlroots backend (xdg-desktop-portal-wlr), and the GTK fallback — enabling screen sharing, portal screenshots, and file dialogs."
---
...
- [`/charly-infrastructure:dbus-layer`](/recipes/infrastructure/dbus-layer/) — D-Bus session bus (required dependency)
- [`/charly-selkies:pipewire`](/recipes/selkies/pipewire/) — PipeWire (required for ScreenCast)
- [`/charly-selkies:sway`](/recipes/selkies/sway/) — Sway compositor (required)
