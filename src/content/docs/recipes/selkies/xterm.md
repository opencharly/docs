---
title: "xterm"
description: "Lightweight X11 terminal emulator (xterm) that triggers on-demand XWayland on labwc/selkies-desktop, enabling X11 automation tools (xdotool, xprop, xwininfo) to find windows."
---
...
- [`/charly-check:wl`](/recipes/check/wl/) — the `wl:` verb's exec / focus / close / xprop / geometry methods
