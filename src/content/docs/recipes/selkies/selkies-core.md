---
title: "selkies-core"
description: "The compositor-agnostic core of the selkies streaming desktop — the pixelflux transport plus the shared desktop fixings consumed by BOTH flavors (labwc and KDE Plasma)."
---
...
[`/charly-selkies:selkies-kde-desktop`](/recipes/selkies/selkies-kde-desktop/) "Encoder is auto-selected").
...
restarting the container (see [`/charly-selkies:chrome`](/recipes/selkies/chrome/) "Chrome supervision").

## Related

- [`/charly-selkies:selkies`](/recipes/selkies/selkies/) — the pixelflux transport at the heart of the core.
- [`/charly-selkies:selkies-desktop-layer`](/recipes/selkies/selkies-desktop-layer/) — the labwc flavor metalayer.
- [`/charly-selkies:selkies-kde-desktop`](/recipes/selkies/selkies-kde-desktop/) — the KDE Plasma flavor metalayer.
- [`/charly-image:layer`](/recipes/image/layer/) — candy authoring; the unified `service:` schema.
