---
title: "wf-recorder"
description: "Wayland screen recorder for wlroots compositors."
---
...
- [`/charly-check:record`](/recipes/check/record/) — the `record:` check verb (`record_mode: desktop`) auto-detects wf-recorder
- [`/charly-selkies:wl-record-pixelflux`](/recipes/selkies/wl-record-pixelflux/) — Alternative for selkies-desktop (pixelflux pipeline)
- [`/charly-selkies:wl-screenshot-grim`](/recipes/selkies/wl-screenshot-grim/) — Screenshot companion (same wlr-screencopy protocol)
- [`/charly-selkies:sway-desktop`](/recipes/selkies/sway-desktop/) — Parent metalayer
