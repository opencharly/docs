---
title: "libnotify"
description: "Desktop notification client library providing notify-send CLI."
---
...
- [`/charly-selkies:swaync`](/recipes/selkies/swaync/) -- notification daemon to display the notifications
- [`/charly-check:dbus`](/recipes/check/dbus/) -- alternative: the `dbus: notify` check verb (served out-of-process by `candy/plugin-dbus`)
