---
title: "ollama-layer"
description: "Ollama LLM server on port 11434 with model persistence, CPU-only by default and opt-in CUDA/ROCm backends composed at the box level."
---
...
- [`/charly-distros:cuda`](/recipes/distros/cuda/) -- CUDA toolkit (GPU boxes compose it at the IMAGE level, not via this candy)
