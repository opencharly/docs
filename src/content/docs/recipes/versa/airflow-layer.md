---
title: "airflow-layer"
description: "Apache Airflow 3.x with LocalExecutor + SQLite (single-node, dev-friendly), 4 supervisord services (init, scheduler, dag-processor, webserver)."
---
...
deps (`apache-airflow`) live in [`/charly-versa:marimo-layer`](/recipes/versa/marimo-layer/)'s pixi env,
...
The marimo notebook in [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) writes its own DAG
...
- [`/charly-versa:marimo-layer`](/recipes/versa/marimo-layer/) — pixi env that owns the airflow Python deps
- [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) — canonical user of the REST trigger pattern
- [`/charly-versa:versa`](/recipes/versa/versa/) — the image composing this layer
- [`/charly-infrastructure:supervisord`](/recipes/infrastructure/supervisord/) — service mgmt
- [`/charly-build:secrets`](/recipes/build/secrets/) — the 3 airflow secrets injected via this layer
