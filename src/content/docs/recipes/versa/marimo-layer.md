---
title: "marimo-layer"
description: "marimo reactive notebook server (also runs as MCP server via --mcp), GPU-accelerated OSM/GTFS analytics deps (cudf-polars-cu13, polars, geopandas, quackosm, gtfs-parquet), Apache Airflow Python deps (the airflow layer ships no pixi env), and the marimo-team/learn curriculum + marimo-team/skills bundle for you."
---
...
[`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) to render martin's vector tiles
...
bypass is documented in [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/).
...
- [`/charly-versa:versa`](/recipes/versa/versa/) — the image that composes this layer
- [`/charly-versa:marimo-mcp`](/recipes/versa/marimo-mcp/) — the MCP server tool catalog
- [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) — the canonical notebook using this env
- [`/charly-distros:cuda`](/recipes/distros/cuda/) — required dep
- [`/charly-infrastructure:supervisord`](/recipes/infrastructure/supervisord/) — required dep
- [`/charly-image:layer`](/recipes/image/layer/) — layer authoring conventions
