---
title: "osm-tools-layer"
description: "OpenStreetMap data pipeline tooling: tippecanoe (GeoJSON → MBTiles/PMTiles, built from source), gdal/ogr2ogr, jq, martin (Rust musl static binary on port 3000), pmtiles CLI."
---
...
[`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) cell 10 uses `mo.iframe` with embedded
...
[`/charly-versa:maputnik-layer`](/recipes/versa/maputnik-layer/) is a visual editor for these styles —
useful for iterating on map appearance without notebook rebuilds.
[`/charly-versa:pmtiles-viewer`](/recipes/versa/pmtiles-viewer/) is a sibling SPA on port 28001 that
...
- [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) — DAG that produces pmtiles + MapLibre cell consuming them
- [`/charly-versa:maputnik-layer`](/recipes/versa/maputnik-layer/) — visual style editor for the same vector tiles
- [`/charly-infrastructure:supervisord`](/recipes/infrastructure/supervisord/) — service runtime
