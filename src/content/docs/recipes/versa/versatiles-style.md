...
description: "The @versatiles/style TypeScript package generates MapLibre style JSON for Shortbread vector tiles."
---
...
- [`/charly-versa:versatiles`](/recipes/versa/versatiles/) — the tile-server backend the generated
  styles point at after URL patching
- [`/charly-versa:versatiles-frontend`](/recipes/versa/versatiles-frontend/) — re-exports this bundle at
  `/style/` for iframe consumption
- [`/charly-versa:shortbread`](/recipes/versa/shortbread/) — the tile schema the styles render
