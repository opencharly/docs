...
helpers. Composed by [`/charly-versa:versa`](/recipes/versa/versa/) so operators can debug
...
- [`/charly-versa:airflow-layer`](/recipes/versa/airflow-layer/) — services this toolkit debugs
- [`/charly-versa:osm-tools-layer`](/recipes/versa/osm-tools-layer/) — martin server this toolkit debugs
- [`/charly-versa:marimo-layer`](/recipes/versa/marimo-layer/) — marimo runtime this toolkit debugs
- [`/charly-coder:dev-tools`](/recipes/coder/dev-tools/) — overlapping but heavier (includes qemu, AWS CLI, etc.); not composed by versa
