---
title: "marimo-mcp"
description: "marimo's built-in MCP server (read-only inspection tools — get_active_notebooks, get_cell_outputs, get_notebook_errors, etc.) at port 2718 path /mcp/server."
---
