...
description: "PMTiles Viewer — visual inspector for PMTiles archives."
---
...
[`/charly-versa:versa`](/recipes/versa/versa/) so operators can inspect any of the four
...
- [`/charly-versa:osm-tools-layer`](/recipes/versa/osm-tools-layer/) — companion martin tile server (the
  four sibling sources the viewer inspects)
- [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) — DAGs producing the four PMTiles
  archives and the four MapLibre cells consuming them
- [`/charly-versa:maputnik-layer`](/recipes/versa/maputnik-layer/) — sibling static-SPA-via-http.server
