...
description: "VersaTiles Frontend — pre-built TypeScript SPA from versatiles-org/versatiles-frontend GitHub releases."
---
...
This contrasts with [`/charly-versa:maputnik-layer`](/recipes/versa/maputnik-layer/) which DOES build
...
- [`/charly-versa:versatiles`](/recipes/versa/versatiles/) — the tile-server backend the frontend
  connects to by default
- [`/charly-versa:versatiles-style`](/recipes/versa/versatiles-style/) — the bundle re-exported under `/style/`
- [`/charly-versa:pmtiles-viewer`](/recipes/versa/pmtiles-viewer/) — sibling static-SPA layer (port 28001)
- [`/charly-versa:maputnik-layer`](/recipes/versa/maputnik-layer/) — sibling static-SPA layer (port 28000)
- [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) — the shortbread MapLibre cell that loads
