---
title: "maputnik-layer"
description: "Maputnik — visual editor for MapLibre GL vector-tile styles."
---
...
`http.server`. Composed by [`/charly-versa:versa`](/recipes/versa/versa/) so operators can
iterate on the streets-map style against the in-pod martin tile
server ([`/charly-versa:osm-tools-layer`](/recipes/versa/osm-tools-layer/)).
...
The streets-map style in [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) cell 7 is a
...
- [`/charly-versa:osm-tools-layer`](/recipes/versa/osm-tools-layer/) — companion martin tile server
- [`/charly-versa:notebook-osm`](/recipes/versa/notebook-osm/) — uses an inline style; maputnik can author richer ones
