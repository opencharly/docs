---
title: "cp"
description: "`charly cp` — copy a file between the host and a running container (app or sidecar)."
---
...
- [`/charly-core:shell`](/recipes/core/shell/) — interactive shell in the same container.
- [`/charly-automation:sidecar`](/recipes/automation/sidecar/) — the sidecar-container model.
