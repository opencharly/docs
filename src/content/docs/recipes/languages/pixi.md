---
title: "pixi"
description: "Pixi package manager binary with environment and PATH setup."
---
...
- [`/charly-distros:fedora-builder`](/recipes/distros/fedora-builder/) (direct)
- [`/charly-distros:arch-builder`](/recipes/distros/arch-builder/) (direct)
- Transitive dependency via `python` / `supervisord` in most service boxes

## Related Candies

- [`/charly-languages:python`](/recipes/languages/python/) -- depends on pixi for Python 3.13 installation
- [`/charly-coder:pre-commit`](/recipes/coder/pre-commit/) -- uses pixi for pre-commit installation
