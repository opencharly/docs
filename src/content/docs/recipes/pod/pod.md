---
title: "pod"
description: "Schema reference for `kind: pod` and deploy entities: charly.yml entry shape, tree-position nesting, sidecars, and pod networking."
---

<!-- DO-NOT-EDIT — generated by `charly docs generate`; run `task docs:sync` to regenerate. -->

*Recipe card from the `charly-pod` plugin (Kinds — schema authoring).*
...
`sidecar:` declares co-running containers with their own env-var routing (`env_accept` / `env_require`). See [`/charly-automation:sidecar`](/recipes/automation/sidecar/) for the topic skill.

## Cross-references

- Verb-level: [`/charly-core:deploy`](/recipes/core/deploy/), [`/charly-core:charly-update`](/recipes/core/charly-update/), [`/charly-core:remove`](/recipes/core/remove/).
- Sibling kinds: [`/charly-image:image`](/recipes/image/image/), [`/charly-vm:vm`](/recipes/vm/vm/), [`/charly-kubernetes:kubernetes`](/recipes/kubernetes/kubernetes/), [`/charly-local:local-spec`](/recipes/local/local-spec/).
- Topics: [`/charly-automation:sidecar`](/recipes/automation/sidecar/), [`/charly-automation:enc`](/recipes/automation/enc/).
