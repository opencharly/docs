---
title: "docs"
description: "The `charly docs generate` verb — the generator rendering the reference half of opencharly.ai from this repo's canonical sources."
---
...
lands (the stale-marketplace gap [`/charly-tools:crabbox`](/recipes/tools/crabbox/) measures — see the tests
...
card references the skill [`/charly-tools:crabbox`](/recipes/tools/crabbox/), whose card exists only through the
