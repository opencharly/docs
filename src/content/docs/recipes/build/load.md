---
title: "load"
description: "Use when a locally-built image has to reach the NESTED podman store inside a running pod — a candybox that runs its own containers."
---
...
`charly vm cp-box` ([`/charly-vm:vm`](/recipes/vm/vm/)); both are bindings of one shared path.
...
([`/charly-distros:nested-podman-socket`](/recipes/distros/nested-podman-socket/)), which serves the nested podman's
