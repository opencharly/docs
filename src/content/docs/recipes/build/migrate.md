...
3. **Land + tag the spec repo** (its Go-module tag scheme `v0.<YYYYDDD>.<HHMM leading-zeros-stripped>` — see [`/charly-internals:git-workflow`](/recipes/internals/git-workflow/)).
