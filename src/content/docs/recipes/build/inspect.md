---
title: "inspect"
description: "Image inspection showing resolved configuration as JSON."
---
...
Invoked as `charly box inspect <image>`. See [`/charly-image:image`](/recipes/image/image/) for the family overview.
...
- [`/charly-build:build`](/recipes/build/build/) -- Build the inspected image
- [`/charly-build:generate`](/recipes/build/generate/) -- Containerfile generation for the inspected image
- [`/charly-build:list`](/recipes/build/list/) -- Enumerate images before inspecting one
- [`/charly-build:merge`](/recipes/build/merge/) -- Post-build layer consolidation
- [`/charly-build:new`](/recipes/build/new/) -- Scaffold new candies
- [`/charly-build:pull`](/recipes/build/pull/) -- Fetch prebuilt images into local storage
- [`/charly-build:validate`](/recipes/build/validate/) -- Validate image and layer definitions before inspect

### Related skills

- [`/charly-image:layer`](/recipes/image/layer/) -- Layer-level detail shown in inspect output
- [`/charly-core:deploy`](/recipes/core/deploy/) -- `charly.yml` overlay applied on top of inspect's resolved config
