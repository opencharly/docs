---
title: "debian-debootstrap-vm"
description: "Debian bootstrap VM (kind:vm debian-debootstrap) — source.kind: bootstrap via debian-debootstrap-builder + debootstrap, ext4 rootfs, uefi-insecure."
---
...
`debootstrap` (using [`/charly-distros:debian-debootstrap-builder`](/recipes/distros/debian-debootstrap-builder/)), then boots it
under libvirt/QEMU.
...
Docker-Hub [`/charly-distros:debian`](/recipes/distros/debian/) container base remains the faster path when you
don't need a VM disk.

## Cross-References

- [`/charly-distros:debian-debootstrap-builder`](/recipes/distros/debian-debootstrap-builder/) — the builder image this VM uses
- [`/charly-distros:debian-debootstrap`](/recipes/distros/debian-debootstrap/) — the container equivalent of this bootstrap path
- [`/charly-vm:ubuntu-debootstrap-vm`](/recipes/vm/ubuntu-debootstrap-vm/) — the Ubuntu sibling bootstrap VM
