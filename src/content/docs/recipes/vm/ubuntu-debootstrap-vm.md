---
title: "ubuntu-debootstrap-vm"
description: "Ubuntu bootstrap VM (kind:vm ubuntu-debootstrap) — source.kind: bootstrap via ubuntu-debootstrap-builder + debootstrap, ext4 rootfs, uefi-insecure."
---
...
`debootstrap` (using [`/charly-distros:ubuntu-debootstrap-builder`](/recipes/distros/ubuntu-debootstrap-builder/)), then boots it
under libvirt/QEMU.
...
Docker-Hub [`/charly-distros:ubuntu`](/recipes/distros/ubuntu/) container base remains the faster path when you
don't need a VM disk.

## Cross-References

- [`/charly-distros:ubuntu-debootstrap-builder`](/recipes/distros/ubuntu-debootstrap-builder/) — the builder image this VM uses
- [`/charly-distros:ubuntu-debootstrap`](/recipes/distros/ubuntu-debootstrap/) — the container equivalent of this bootstrap path
- [`/charly-vm:debian-debootstrap-vm`](/recipes/vm/debian-debootstrap-vm/) — the Debian sibling bootstrap VM
