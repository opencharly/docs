---
title: "hermes"
description: "Full-featured standalone Hermes AI agent with AI CLIs, dev tools, DevOps tools, and charly."
---
...
- [`/charly-hermes:hermes-full-layer`](/recipes/hermes/hermes-full-layer/) — Metalayer composition details
- [`/charly-hermes:hermes`](/recipes/hermes/hermes/) — Core agent (env_accept, browser dispatch, LLM config)
- [`/charly-selkies:chrome`](/recipes/selkies/chrome/) — Provides `BROWSER_CDP_URL` (from selkies-desktop)
- [`/charly-selkies:chrome-devtools-mcp`](/recipes/selkies/chrome-devtools-mcp/) — Chrome DevTools MCP server on port 9224 (from selkies-desktop)

## Related Boxes

- [`/charly-hermes:hermes-playwright`](/recipes/hermes/hermes-playwright/) — Hermes with local Playwright Chromium
- [`/charly-selkies:selkies-labwc`](/recipes/selkies/selkies-labwc/) — Desktop with Chrome (cross-container browser provider)
- [`/charly-jupyter:jupyter`](/recipes/jupyter/jupyter/) — JupyterLab with MCP (cross-container MCP provider)
...
liveness (hermes-whatsapp is autostart=false — see [`/charly-check:check`](/recipes/check/check/) Gotcha #4).

## Related Skills

- [`/charly-hermes:hermes-full-layer`](/recipes/hermes/hermes-full-layer/), [`/charly-hermes:hermes`](/recipes/hermes/hermes/), [`/charly-coder:claude-code`](/recipes/coder/claude-code/),
  [`/charly-coder:codex`](/recipes/coder/codex/), [`/charly-coder:gemini`](/recipes/coder/gemini/), [`/charly-coder:dev-tools`](/recipes/coder/dev-tools/),
  [`/charly-coder:devops-tools`](/recipes/coder/devops-tools/)
- [`/charly-check:check`](/recipes/check/check/) — declarative testing framework + supervisord gotchas
- [`/charly-core:charly-config`](/recipes/core/charly-config/) — `CHARLY_MCP_SERVERS` auto-discovery + secret provisioning
- [`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) — verify each MCP server in `CHARLY_MCP_SERVERS` is actually alive before debugging hermes tool-call failures; `charly check live <provider-image> --filter mcp` shows exactly what hermes will see
- [`/charly-selkies:selkies-labwc`](/recipes/selkies/selkies-labwc/) — companion for shared browser (CDP)
- [`/charly-jupyter:jupyter`](/recipes/jupyter/jupyter/) — MCP notebook tools auto-discovered
