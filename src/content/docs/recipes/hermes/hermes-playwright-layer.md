---
title: "hermes-playwright-layer"
description: "Playwright Chromium browser for Hermes Agent with Fedora-compatible system deps."
---
...
- [`/charly-hermes:hermes-playwright`](/recipes/hermes/hermes-playwright/) -- hermes with Playwright Chromium

## Related Candies

- [`/charly-hermes:hermes`](/recipes/hermes/hermes/) -- base hermes agent (required dependency)
- [`/charly-selkies:chrome`](/recipes/selkies/chrome/) -- similar pattern for Chrome system deps
- [`/charly-hermes:playwright-layer`](/recipes/hermes/playwright-layer/) -- OpenClaw's Playwright layer (npm only, no Chromium binary)
