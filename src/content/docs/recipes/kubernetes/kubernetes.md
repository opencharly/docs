---
title: "kubernetes"
description: "MUST be invoked before any work involving: `charly bundle add --target kubernetes`, `charly bundle from-box`, Kustomize manifest generation, cluster profiles, K8s deployments, `kubernetes:` block in deploy spec, or OCI-label capabilities."
---
...
- [`/charly-core:deploy`](/recipes/core/deploy/) — unified `charly bundle add`/`del` verb; K8s is one of three targets
