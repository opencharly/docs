...
description: "Operator CachyOS workstation profile — a kind:local template plus a host:local deploy that installs the full dev stack (30 candies) onto a CachyOS host via ShellExecutor."
---
