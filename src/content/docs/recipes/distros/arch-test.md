---
title: "arch-test"
description: "Test box for Arch Linux pacman and AUR package installation."
---
...
- [`/charly-distros:arch`](/recipes/distros/arch/) — base image
- [`/charly-distros:arch-builder`](/recipes/distros/arch-builder/) — builder image (provides yay for AUR builds)
- [`/charly-distros:arch-pac-test`](/recipes/distros/arch-pac-test/) — pacman test candy
- [`/charly-distros:arch-aur-test`](/recipes/distros/arch-aur-test/) — AUR test candy
