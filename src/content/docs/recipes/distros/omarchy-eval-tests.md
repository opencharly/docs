---
title: "omarchy-eval-tests"
description: "The omarchy test-corpus map — the Config Oracle's guide to selecting the charly-native corpus beds that make sense for a PR."
---
