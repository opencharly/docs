...
description: "Bootstrap-from-scratch Ubuntu 24.04 rootfs via debootstrap inside a privileged builder (from: builder:debootstrap, bootstrap_builder_image: ubuntu-debootstrap-builder)."
---
...
`debootstrap` inside the privileged [`/charly-distros:ubuntu-debootstrap-builder`](/recipes/distros/ubuntu-debootstrap-builder/)
...
The canonical Ubuntu base ([`/charly-distros:ubuntu`](/recipes/distros/ubuntu/)) pulls the upstream-published
...
- [`/charly-distros:ubuntu`](/recipes/distros/ubuntu/) — the recommended Docker-Hub base
- [`/charly-distros:ubuntu-debootstrap-builder`](/recipes/distros/ubuntu-debootstrap-builder/) — the privileged builder it uses
