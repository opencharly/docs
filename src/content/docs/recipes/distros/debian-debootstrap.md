...
description: "Bootstrap-from-scratch Debian rootfs via debootstrap inside a privileged builder (from: builder:debootstrap, bootstrap_builder_image: debian-debootstrap-builder)."
---
...
the privileged [`/charly-distros:debian-debootstrap-builder`](/recipes/distros/debian-debootstrap-builder/) container
...
The canonical Debian base ([`/charly-distros:debian`](/recipes/distros/debian/)) pulls the upstream-published
...
[`/charly-distros:arch`](/recipes/distros/arch/) / [`/charly-distros:cachyos-pacstrap`](/recipes/distros/cachyos-pacstrap/)).
...
- [`/charly-distros:debian`](/recipes/distros/debian/) — the recommended Docker-Hub base
- [`/charly-distros:debian-debootstrap-builder`](/recipes/distros/debian-debootstrap-builder/) — the privileged builder it uses
