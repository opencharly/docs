...
description: "The teaching box quoted end to end by opencharly.ai — a minimal, real dev shell composing one tool candy and one service candy, with the container init injected."
---
