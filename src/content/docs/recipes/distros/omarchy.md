---
title: "omarchy"
description: "Omarchy base image (`box/omarchy`) — vanilla Arch plus Omarchy's own package sources and runtime, built from `arch.arch`."
---
...
namespace — the same arrangement [`/charly-distros:cachyos`](/recipes/distros/cachyos/) uses.
...
- `omarchy-cstream` — the streamed desktop (see [`/charly-distros:omarchy-cstream`](/recipes/distros/omarchy-cstream/))
...
- [`/charly-distros:arch`](/recipes/distros/arch/) — the Arch base this derives from
- [`/charly-vm:omarchy-vm`](/recipes/vm/omarchy-vm/) — the ISO-installed VM
- [`/charly-image:image`](/recipes/image/image/) — box family umbrella
