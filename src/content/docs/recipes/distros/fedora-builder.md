...
description: "Builder image with pixi, Node.js, and C/C++ build toolchain."
---
...
[`/charly-distros:fedora`](/recipes/distros/fedora/) + [`/charly-distros:fedora-nonfree`](/recipes/distros/fedora-nonfree/); the submodule is
...
- [`/charly-languages:pixi`](/recipes/languages/pixi/) — Python package management foundation
- [`/charly-coder:nodejs`](/recipes/coder/nodejs/) — Node.js runtime and npm
- [`/charly-coder:build-toolchain`](/recipes/coder/build-toolchain/) — C/C++ compilation tools

## Related Boxes

- [`/charly-distros:fedora`](/recipes/distros/fedora/) — parent base
