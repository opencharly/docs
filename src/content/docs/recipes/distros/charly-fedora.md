---
title: "charly-fedora"
description: "Fedora box with the full charly toolchain using shared candies."
---
...
candy list as [`/charly-coder:charly-arch`](/recipes/coder/charly-arch/) — the tag system handles
Fedora-specific packages and scripts via `rpm:` sections. Supports
nested containers at any depth via [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/).
...
| Network | host |
| Security | layer-level only (from [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/)) |
| Registry | ghcr.io/opencharly |

### Rootless-first posture

Runs as uid=1000 / `user` with no added capabilities. The
[`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) kernel RCA establishes that
...
power-user siblings ([`/charly-coder:charly-arch`](/recipes/coder/charly-arch/), [`/charly-coder:fedora-coder`](/recipes/coder/fedora-coder/),
[`/charly-distros:githubrunner`](/recipes/distros/githubrunner/)) — needs no `cap_add: [ALL]` or
...
Both `charly-fedora` and [`/charly-coder:charly-arch`](/recipes/coder/charly-arch/) use the exact same candy
...
- [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) — nested rootless podman/buildah (authoritative RCA for `mount_too_revealing()` + `unmask=/proc/*`)
- [`/charly-coder:sshd`](/recipes/coder/sshd/) — SSH daemon + passwordless sudo for `user`
...
- [`/charly-core:shell`](/recipes/core/shell/) — open an interactive shell in charly-fedora (as uid=1000 with sudo)
- [`/charly-core:service`](/recipes/core/service/) — manage charly-fedora as a service
- [`/charly-vm:vm`](/recipes/vm/vm/) — nested libvirt VMs via `qemu:///session` (rootless)
- [`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) — MCP gateway deployment patterns (if you add `charly-mcp` to the candies)
