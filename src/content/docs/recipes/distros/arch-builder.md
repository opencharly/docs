---
title: "arch-builder"
description: "Arch Linux builder image with pixi, Node.js, build toolchain, and yay AUR helper."
---
...
Builder image for Arch Linux multi-stage builds. Counterpart to [`/charly-distros:fedora-builder`](/recipes/distros/fedora-builder/) — provides the same build capabilities (pixi, npm, cargo) plus AUR support via yay.
...
- [`/charly-distros:fedora-builder`](/recipes/distros/fedora-builder/) — Fedora counterpart (same role, no AUR)
- [`/charly-tools:yay`](/recipes/tools/yay/) — AUR helper candy (unique to Arch)
- [`/charly-languages:pixi`](/recipes/languages/pixi/) — pixi package manager candy
- [`/charly-coder:nodejs`](/recipes/coder/nodejs/) — Node.js candy
- [`/charly-coder:build-toolchain`](/recipes/coder/build-toolchain/) — C/C++ build tools candy
