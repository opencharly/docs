...
description: "Bootstrap-from-scratch CachyOS rootfs via pacstrap inside a privileged builder."
---
...
privileged [`/charly-distros:cachyos-pacstrap-builder`](/recipes/distros/cachyos-pacstrap-builder/) container
...
The canonical CachyOS base ([`/charly-distros:cachyos`](/recipes/distros/cachyos/)) pulls the upstream-published
...
with this fix — newer than the published release.) The Docker-Hub [`/charly-distros:cachyos`](/recipes/distros/cachyos/)
...
- [`/charly-distros:cachyos`](/recipes/distros/cachyos/) — the recommended Docker-Hub base
- [`/charly-distros:cachyos-pacstrap-builder`](/recipes/distros/cachyos-pacstrap-builder/) — the privileged builder it uses
- [`/charly-vm:cachyos-bootstrap-vm`](/recipes/vm/cachyos-bootstrap-vm/) — the VM built via the same pacstrap path
