---
title: "debian"
description: "Base Debian 13 trixie image."
---
...
(see [`/charly-distros:ubuntu`](/recipes/distros/ubuntu/)). Nothing in main consumes any Debian box, so there
...
This is the intentional asymmetry vs [`/charly-distros:ubuntu`](/recipes/distros/ubuntu/), which DOES ship `ubuntu:ubuntu` at uid 1000 and declares `base_user:` to adopt that identity. See [`/charly-image:image`](/recipes/image/image/) "user_policy" and [`/charly-build:build`](/recipes/build/build/) "base_user" for the full decision table.
...
- [`/charly-distros:debian-builder`](/recipes/distros/debian-builder/) — pixi/npm/cargo multi-stage builder on this base.
- [`/charly-coder:debian-coder`](/recipes/coder/debian-coder/) — kitchen-sink dev box on this base.
- [`/charly-distros:debian-debootstrap-builder`](/recipes/distros/debian-debootstrap-builder/) — privileged debootstrap builder (`base: debian:13`).
- [`/charly-distros:debian-debootstrap`](/recipes/distros/debian-debootstrap/) — bootstrap-from-scratch rootfs (`from: builder:debootstrap`).
- [`/charly-vm:debian-debootstrap-vm`](/recipes/vm/debian-debootstrap-vm/) — the `debian-debootstrap` bootstrap VM + `check-debian-debootstrap-vm` bed.
...
- [`/charly-distros:ubuntu`](/recipes/distros/ubuntu/) — deb-family sibling base in the separate `opencharly/distro-ubuntu` submodule; ships `base_user:` + adopts ubuntu:ubuntu.
- [`/charly-distros:debian-builder`](/recipes/distros/debian-builder/) — multi-stage builder on top of this box.
- [`/charly-coder:debian-coder`](/recipes/coder/debian-coder/) — kitchen-sink dev box on this base.
- [`/charly-distros:fedora`](/recipes/distros/fedora/) — RPM-family counterpart.
- [`/charly-distros:arch`](/recipes/distros/arch/) — pacman-family counterpart (separate `opencharly/distro-arch` submodule).

## Related commands

- [`/charly-build:build`](/recipes/build/build/) — `base_user:` declaration format + bootstrap packages.
- [`/charly-image:image`](/recipes/image/image/) — `user_policy:` reconciliation.
- [`/charly-build:generate`](/recipes/build/generate/) — writeBootstrap emission.
