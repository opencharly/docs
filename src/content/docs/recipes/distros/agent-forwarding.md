...
description: "Agent forwarding support -- GPG, SSH, and direnv for .secrets workflow."
---
...
- [`/charly-infrastructure:gnupg`](/recipes/infrastructure/gnupg/) -- GnuPG encryption tools (part of this metalayer)
- [`/charly-coder:direnv`](/recipes/coder/direnv/) -- direnv environment loader (part of this metalayer)
- [`/charly-infrastructure:ssh-client`](/recipes/infrastructure/ssh-client/) -- OpenSSH client (part of this metalayer)
- [`/charly-coder:sshd`](/recipes/coder/sshd/) -- SSH server (separate, for images that need inbound SSH)
- [`/charly-infrastructure:gocryptfs`](/recipes/infrastructure/gocryptfs/) -- encrypted filesystem (separate credential system)

## Cross-References

- [`/charly-build:secrets`](/recipes/build/secrets/) -- `charly secrets gpg` for managing `.secrets` files, GPG key management (`import-key`, `export-key`, `setup`, `doctor`), KeePassXC integration; credential store for container secrets
- [`/charly-core:shell`](/recipes/core/shell/) -- where SSH/GPG agent forwarding happens at runtime
- [`/charly-core:service`](/recipes/core/service/) -- `charly start` direct mode forwarding
- [`/charly-core:charly-config`](/recipes/core/charly-config/) -- `forward_gpg_agent`, `forward_ssh_agent` settings
- [`/charly-core:deploy`](/recipes/core/deploy/) -- per-box forwarding overrides in charly.yml
