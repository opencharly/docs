---
title: "charly-arch"
description: "Arch Linux box with the full charly toolchain."
---
...
candy list as [`/charly-distros:charly-fedora`](/recipes/distros/charly-fedora/) — the tag system handles
...
| Security | candy-level only (from [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/)) |
| Registry | ghcr.io/opencharly |

### Rootless-first posture

All four power-user boxes (`charly-arch`, [`/charly-distros:charly-fedora`](/recipes/distros/charly-fedora/),
[`/charly-coder:fedora-coder`](/recipes/coder/fedora-coder/), [`/charly-distros:githubrunner`](/recipes/distros/githubrunner/)) run rootless because
the [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) kernel-level RCA proves that
`unmask=/proc/*` + uid-delegation via subuid/subgid ranges is sufficient for
rootless nested containers + rootless libvirt VMs.

The [`/charly-coder:sshd`](/recipes/coder/sshd/) candy installs `/etc/sudoers.d/charly-user` with
...
|---|---|
| `cap_add` | **(empty)** |
| `security_opt` | `[unmask=/proc/*]` (from [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/)) |
...
`/workspace`. See [`/charly-coder:charly-mcp`](/recipes/coder/charly-mcp/) for full deployment patterns,
[`/charly-build:charly-mcp-cmd`](/recipes/build/charly-mcp-cmd/) Part 2 for the server architecture, and [`/charly-core:charly-config`](/recipes/core/charly-config/)
...
- **gh** — GitHub CLI + `git` + `git-lfs` (single-responsibility; see [`/charly-coder:gh`](/recipes/coder/gh/))
...
- **nvidia** — nvidia-utils, nvidia-container-toolkit (CDI generation; benign pacman-hook NVML noise on GPU-less hosts — see [`/charly-distros:nvidia`](/recipes/distros/nvidia/))
...
[`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) candy provides the config + env vars +
...
The [`/charly-distros:nvidia`](/recipes/distros/nvidia/) candy provides NVIDIA GPU runtime:
...
Both `charly-arch` and [`/charly-distros:charly-fedora`](/recipes/distros/charly-fedora/) use the exact same candy
...
- [`/charly-tools:charly`](/recipes/tools/charly/) — the full toolchain: charly binary plus VM/encryption tools
- [`/charly-coder:charly-mcp`](/recipes/coder/charly-mcp/) — MCP server gateway (port 18765; `/workspace` bind-mount or auto-fallback)
- [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) — nested podman/buildah (pac: podman + crun + buildah; `docker` is RPM-only — Arch gets podman directly)
- [`/charly-coder:sshd`](/recipes/coder/sshd/) — SSH server/client with `package_map` for cross-distro package names + the passwordless-sudo sudoers drop-in
- [`/charly-coder:gh`](/recipes/coder/gh/) — GitHub CLI + git + git-lfs (owns all git tooling)
- [`/charly-distros:nvidia`](/recipes/distros/nvidia/) — NVIDIA GPU runtime
