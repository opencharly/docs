...
description: "C/C++ build toolchain with gcc, cmake, autoconf, ninja, git, and pkg-config."
---
...
Wayland compositor from source. See [`/charly-coder:rust`](/recipes/coder/rust/) for the disambiguation between
...
[`/charly-distros:fedora-builder`](/recipes/distros/fedora-builder/) now includes [`/charly-distros:rpmfusion`](/recipes/distros/rpmfusion/) **before**
...
See [`/charly-selkies:selkies`](/recipes/selkies/selkies/) (Patched pixelflux build pipeline) for the consumer story —
...
- [`/charly-distros:fedora-builder`](/recipes/distros/fedora-builder/)
- [`/charly-distros:arch-builder`](/recipes/distros/arch-builder/)

## Related Candies
- [`/charly-languages:pixi`](/recipes/languages/pixi/) — Sibling in builder images for conda-forge package builds
- [`/charly-coder:nodejs`](/recipes/coder/nodejs/) — Sibling in builder images for npm package builds
- [`/charly-tools:yay`](/recipes/tools/yay/) — Pairs in arch-builder for AUR builds
- [`/charly-coder:rust`](/recipes/coder/rust/) — Disambiguates the builder-stage `rust`+`cargo` packages here from the runtime `rust` candy
- [`/charly-distros:rpmfusion`](/recipes/distros/rpmfusion/) — Must be applied **before** this candy in fedora-builder so codec dev libs (`x264-devel`, `ffmpeg-devel`) can install
- [`/charly-selkies:selkies`](/recipes/selkies/selkies/) — Primary consumer of all the new cargo/codec deps (Patched pixelflux build pipeline)

## Related Commands
- [`/charly-build:build`](/recipes/build/build/) — Multi-stage builders consume this candy for pixi/npm/cargo builds
- [`/charly-build:generate`](/recipes/build/generate/) — See how builder stages are generated from this candy
