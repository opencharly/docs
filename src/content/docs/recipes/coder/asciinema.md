...
- [`/charly-check:record`](/recipes/check/record/) — Terminal recording via asciinema (start, stop, cmd, gif)

## Cross-References

- [`/charly-check:record`](/recipes/check/record/) — the `record:` check verb (`record_mode: terminal` records, `record: gif` renders) uses asciinema + agg
