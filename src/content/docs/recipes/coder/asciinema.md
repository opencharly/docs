---
title: "asciinema"
description: "Terminal session recorder (asciinema)."
---
...
- [`/charly-check:record`](/recipes/check/record/) — Terminal recording via asciinema (start, stop, cmd)

## Cross-References

- [`/charly-check:record`](/recipes/check/record/) — the `record:` check verb (`record_mode: terminal`) uses asciinema
- [`/charly-coder:dev-tools`](/recipes/coder/dev-tools/) — Also includes asciinema (larger candy)
