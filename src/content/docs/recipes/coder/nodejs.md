---
title: "nodejs"
description: "Node.js and npm via system packages (RPM/DEB) with global npm prefix."
---
...
- [`/charly-coder:pre-commit`](/recipes/coder/pre-commit/) -- depends on nodejs
- [`/charly-immich:immich-layer`](/recipes/immich/immich-layer/) -- uses the candy's pnpm to build Immich
