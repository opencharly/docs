---
title: "yay"
description: "AUR helper for Arch Linux, enabling aur: package sections in charly.yml."
---
...
- [`/charly-distros:arch-builder`](/recipes/distros/arch-builder/) — Arch build infrastructure image

## Related Candies

- [`/charly-coder:build-toolchain`](/recipes/coder/build-toolchain/) — C/C++ build tools (also in arch-builder)
- [`/charly-distros:arch-aur-test`](/recipes/distros/arch-aur-test/) — test candy that validates AUR builds
