---
title: "goplaces"
description: "Google Places API CLI for location search."
---
...
- [`/charly-core:shell`](/recipes/core/shell/) — run goplaces interactively inside a container
- [`/charly-build:build`](/recipes/build/build/) — compiles goplaces via the Go builder during image build
