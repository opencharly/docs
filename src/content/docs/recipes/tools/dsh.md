---
title: "dsh"
description: "DeepSeek Harness (dsh) CLI + web UI via npm with a socat-exposed web service on port 3080."
---
...
- [`/charly-coder:nodejs`](/recipes/coder/nodejs/) -- required runtime dependency (node >=22.19.0)
- [`/charly-tools:mcporter`](/recipes/tools/mcporter/) -- sibling npm-global CLI candy
