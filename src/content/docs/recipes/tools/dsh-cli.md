---
title: "dsh-cli"
description: "The compiled-in `charly dsh` management CLI for a deployed deepseek-harness (dsh) box."
---
...
- [`/charly-tools:dsh`](/recipes/tools/dsh/) — the dsh candy: the npm-installed CLI + the socat-exposed web service.
