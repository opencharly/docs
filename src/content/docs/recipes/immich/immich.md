---
title: "immich"
description: "Immich photo management server on port 2283."
---
...
- [`/charly-distros:rpmfusion`](/recipes/distros/rpmfusion/) — non-free codec support (via fedora-nonfree base)

## Related Boxes

- [`/charly-distros:fedora-nonfree`](/recipes/distros/fedora-nonfree/) — parent base
- [`/charly-immich:immich-ml`](/recipes/immich/immich-ml/) — adds CUDA ML for face recognition and smart search
