---
title: "immich-ml-layer"
description: "Immich machine learning backend on port 3003 for photo classification and search."
---
...
- [`/charly-immich:immich`](/recipes/immich/immich/) -- required base (provides server + database)
- [`/charly-distros:cuda`](/recipes/distros/cuda/) -- GPU acceleration (when used in cuda boxes)
