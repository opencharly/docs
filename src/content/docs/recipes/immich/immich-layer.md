---
title: "immich-layer"
description: "Immich photo management server on port 2283 with PostgreSQL and Redis."
---
...
- [`/charly-coder:nodejs`](/recipes/coder/nodejs/) -- Node.js runtime dependency (provides pnpm for the Immich build)
- [`/charly-infrastructure:postgresql`](/recipes/infrastructure/postgresql/) -- database dependency
- [`/charly-infrastructure:redis`](/recipes/infrastructure/redis/) -- cache dependency
- [`/charly-selkies:ffmpeg`](/recipes/selkies/ffmpeg/) -- FFmpeg multimedia (nonfree codecs) — required dependency
- [`/charly-infrastructure:vectorchord`](/recipes/infrastructure/vectorchord/) -- VectorChord extension (migration script creates it if available)
- [`/charly-immich:immich-ml`](/recipes/immich/immich-ml/) -- optional ML backend
