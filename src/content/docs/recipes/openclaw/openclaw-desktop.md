...
`base: cachyos.cachyos` ([`/charly-distros:cachyos`](/recipes/distros/cachyos/), reached via the `cachyos` import
...
| `shm_size` | `1g` (from [`/charly-selkies:chrome`](/recipes/selkies/chrome/)) |
| `memory_max` | `6g` (from [`/charly-selkies:chrome`](/recipes/selkies/chrome/)) |
| `privileged` | `false` |
...
documented in [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) with the full kernel-level RCA.
...
See [`/charly-distros:container-nesting`](/recipes/distros/container-nesting/) for the full kernel-level RCA. The short
...
See [`/charly-infrastructure:virtualization`](/recipes/infrastructure/virtualization/). `virtqemud --timeout 0` +
...
- [`/charly-openclaw:openclaw-full`](/recipes/openclaw/openclaw-full/) — gateway + 27 tools (claude-code/codex/gemini)
...
- [`/charly-infrastructure:virtualization`](/recipes/infrastructure/virtualization/) — supervisord-managed virtqemud/virtnetworkd
- [`/charly-distros:agent-forwarding`](/recipes/distros/agent-forwarding/) — GPG/SSH/direnv agent sockets
...
- [`/charly-distros:charly-fedora`](/recipes/distros/charly-fedora/) / [`/charly-coder:charly-arch`](/recipes/coder/charly-arch/) — root-mode charly toolchain WITHOUT a streaming desktop.
...
- [`/charly-check:check`](/recipes/check/check/) — declarative testing + the `check-openclaw-desktop-pod` R10 bed
- [`/charly-check:cdp`](/recipes/check/cdp/), [`/charly-check:wl`](/recipes/check/wl/) — desktop automation on this box
- [`/charly-core:charly-config`](/recipes/core/charly-config/) — deploy setup (tunnel, port remapping, multi-instance, encrypted volumes)
