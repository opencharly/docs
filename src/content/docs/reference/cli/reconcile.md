---
title: "reconcile"
description: "The reconcile command word, served by 2 plugin candies: plugin-box and plugin-box."
---
...
| **plugin-box — Served by** | [plugin-box](/reference/plugin/github-com-opencharly-plugin-box-v2026-266-1110/plugin-box/) |
| **plugin-box — Placement** | compiled-in (in-process) |
| **plugin-box — Version** | `2026.194.0000` |

`reconcile` is a command word served by 2 plugin candies — `plugin-box` and `plugin-box` — at different points in the command tree. Both are real invocations; `charly --help` prints which is which.
...
`charly --help` prints the command tree, including where each `reconcile` is invoked and under which parent.
