---
title: "vm"
description: "The vm command word, served by 2 plugin candies: plugin-vm and plugin-vm."
---
...
| **plugin-vm — Served by** | [plugin-vm](/reference/plugin/github-com-opencharly-plugin-vm-v2026-260-1314/plugin-vm/) |
| **plugin-vm — Placement** | compiled-in (in-process) |
| **plugin-vm — Version** | `2026.177.0400` |
...
## About `plugin-vm`, which serves it
...
`charly --help` prints the command tree, including where each `vm` is invoked and under which parent.
