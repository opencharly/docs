---
title: "tui"
description: "The tui command word, served by 2 plugin candies: plugin-agent and plugin-agent."
---
...
`charly --help` prints the command tree, including where each `tui` is invoked and under which parent.
