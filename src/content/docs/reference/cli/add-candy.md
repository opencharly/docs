...
| | |
|---|---|
| **Served by** | [plugin-authoring](/reference/plugin/github.com/opencharly/plugin-authoring:v2026.237.1414/plugin-authoring/) |
...
`charly --help` prints the command tree, including where `add-candy` is invoked and under which parent.
