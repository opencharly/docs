---
title: "add-candy"
description: "The add-candy command word, served by 2 plugin candies: plugin-authoring and plugin-authoring."
---
...
`add-candy` is a command word served by 2 plugin candies — `plugin-authoring` and `plugin-authoring` — at different points in the command tree. Both are real invocations; `charly --help` prints which is which.

## About `plugin-authoring`, which serves it
...
`charly --help` prints the command tree, including where each `add-candy` is invoked and under which parent.
