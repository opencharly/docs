---
title: "doctor"
description: "The doctor command word, served by 2 plugin candies: plugin-doctor and plugin-doctor."
---
...
## About `plugin-doctor`, which serves it
...
`charly --help` prints the command tree, including where each `doctor` is invoked and under which parent.
