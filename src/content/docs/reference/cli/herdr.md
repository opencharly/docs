---
title: "herdr"
description: "The herdr command word, served by 2 plugin candies: plugin-herdr and plugin-herdr."
---
...
| | |
|---|---|
| **plugin-herdr — Served by** | [plugin-herdr](/reference/plugin/github-com-opencharly-plugin-herdr-v2026-245-1008/plugin-herdr/) |
| **plugin-herdr — Placement** | runtime (out-of-process over gRPC) |
| **plugin-herdr — Version** | `2026.245.1000` |
| **plugin-herdr — Served by** | [plugin-herdr](/reference/plugin/github-com-opencharly-plugin-herdr-v2026-251-0850/plugin-herdr/) |
| **plugin-herdr — Placement** | runtime (out-of-process over gRPC) |
| **plugin-herdr — Version** | `2026.245.1000` |
...
## About `plugin-herdr`, which serves it
