---
title: "remove"
description: "The remove command word, served by 2 plugin candies: plugin-pod and plugin-pod."
---
...
`charly --help` prints the command tree, including where each `remove` is invoked and under which parent.
