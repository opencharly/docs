...
| | |
|---|---|
| **Served by** | [plugin-pod](/reference/plugin/github.com/opencharly/plugin-pod:v2026.250.0546/plugin-pod/) |
...
`charly --help` prints the command tree, including where `remove` is invoked and under which parent.
