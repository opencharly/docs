---
title: "check"
description: "The check command word, served by 2 plugin candies: plugin-check and plugin-check."
---
...
| **plugin-check — Served by** | [plugin-check](/reference/plugin/github-com-opencharly-plugin-check-v2026-254-0445/plugin-check/) |
| **plugin-check — Placement** | compiled-in (in-process) |
| **plugin-check — Version** | `2026.242.2345` |
...
## About `plugin-check`, which serves it
...
`charly --help` prints the command tree, including where each `check` is invoked and under which parent.
