...
| | |
|---|---|
| **Served by** | [plugin-box](/reference/plugin/github.com/opencharly/plugin-box:v2026.251.1834/plugin-box/) |
...
`charly --help` prints the command tree, including where `generate` is invoked and under which parent.
