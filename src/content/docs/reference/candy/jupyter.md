---
title: "jupyter"
description: "JupyterLab notebook server with a CRDT MCP server for agent-driven notebook editing."
---
...
JupyterLab notebook server with a CRDT MCP server for agent-driven notebook editing.
