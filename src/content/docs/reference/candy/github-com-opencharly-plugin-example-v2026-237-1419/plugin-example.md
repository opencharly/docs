...
| **Repo** | `box/github.com/opencharly/plugin-example:v2026.237.1419` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github-com-opencharly-plugin-example-v2026-237-1419/plugin-example/) |
