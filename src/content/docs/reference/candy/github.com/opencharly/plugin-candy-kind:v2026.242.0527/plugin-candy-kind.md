...
| **Repo** | `box/github.com/opencharly/plugin-candy-kind:v2026.242.0527` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-candy-kind:v2026.242.0527/plugin-candy-kind/) |
...
| Intent | Step |
|---|---|
| `check` | the candy box⊻layer factory kind plugin ships a buildable Go module the host compiles in (default) or serves out-of-process; its box⊻layer decode (candyIsImage + buildCandy → uf.Box / uf.Candy) is exercised by EVERY box and layer decode across the whole ecosystem (check-candy-kind / box-fedora / box-arch / box-cachyos / box-debian / box-ubuntu — every image and composed layer) |
