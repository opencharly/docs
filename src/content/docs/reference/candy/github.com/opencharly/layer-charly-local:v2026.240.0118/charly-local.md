...
| **Repo** | `box/github.com/opencharly/layer-charly-local:v2026.240.0118` |
...
| `check` | the local concept candy's skill entities are present and generated into the marketplace's local/skills |
