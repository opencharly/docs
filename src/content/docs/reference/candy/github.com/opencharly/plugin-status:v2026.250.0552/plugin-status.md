...
| **Repo** | `box/github.com/opencharly/plugin-status:v2026.250.0552` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-status:v2026.250.0552/plugin-status/) |
