...
| **Repo** | `box/github.com/opencharly/plugin-group:v2026.242.0529` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-group:v2026.242.0529/plugin-group/) |
...
| Intent | Step |
|---|---|
| `check` | the group structural kind plugin ships a buildable Go module the host compiles in (default) or serves out-of-process; its structural entity decode is exercised by any deploy composing a `group:` node (check-group / check-k8s-deploy / box-fedora / box-cachyos) |
