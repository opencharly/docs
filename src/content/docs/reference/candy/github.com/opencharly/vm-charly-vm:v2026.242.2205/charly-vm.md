...
| **Repo** | `box/github.com/opencharly/vm-charly-vm:v2026.242.2205` |
...
| `check` | the vm concept candy's skill entities are present and generated into the marketplace's vm/skills |
