...
| **Repo** | `box/github.com/opencharly/plugin-spice:v2026.237.1428` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-spice:v2026.237.1428/plugin-spice/) |
