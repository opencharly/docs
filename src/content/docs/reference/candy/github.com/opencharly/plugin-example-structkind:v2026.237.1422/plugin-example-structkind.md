...
| **Repo** | `box/github.com/opencharly/plugin-example-structkind:v2026.237.1422` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-example-structkind:v2026.237.1422/plugin-example-structkind/) |
...
| Intent | Step |
|---|---|
| `check` | the out-of-tree structural class:kind plugin ships a buildable Go module the host can build + serve out-of-process |
