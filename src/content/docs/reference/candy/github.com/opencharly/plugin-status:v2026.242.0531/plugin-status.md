...
| **Repo** | `box/github.com/opencharly/plugin-status:v2026.242.0531` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-status:v2026.242.0531/plugin-status/) |
