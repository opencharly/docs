...
| **Repo** | `box/github.com/opencharly/plugin-dbus:v2026.242.0556` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-dbus:v2026.242.0556/plugin-dbus/) |
