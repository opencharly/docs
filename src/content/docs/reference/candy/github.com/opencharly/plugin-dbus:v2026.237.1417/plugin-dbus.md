...
| **Repo** | `box/github.com/opencharly/plugin-dbus:v2026.237.1417` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-dbus:v2026.237.1417/plugin-dbus/) |
