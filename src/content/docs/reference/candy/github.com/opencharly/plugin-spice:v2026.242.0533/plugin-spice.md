...
| **Repo** | `box/github.com/opencharly/plugin-spice:v2026.242.0533` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github.com/opencharly/plugin-spice:v2026.242.0533/plugin-spice/) |
...
| Intent | Step |
|---|---|
| `check` | the SPICE wire handshake completes against the bed VM (the out-of-process plugin verb dispatches through the registry and dials the host-resolved SPICE endpoint) |
