...
| **Repo** | `box/github.com/opencharly/plugin-oci:v2026.266.1239` |
| **Plugin** | yes — see the [plugin reference](/reference/plugin/github-com-opencharly-plugin-oci-v2026-266-1239/plugin-oci/) |
...
| `check` | the plugin ships the verb:oci cache-push / cache-pull transport for a named spec/cache ArtifactStore (an OCI Image Layout) and its lossless layout round-trip is locked by TestCacheTransportDeterministic |
