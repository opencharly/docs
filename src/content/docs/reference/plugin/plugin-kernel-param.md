...
| **Source** | `github.com/opencharly/charly/candy/plugin-kernel-param` |
...
See also the [candy reference](/reference/candy/plugin-kernel-param/) for this candy's install surface.
