---
title: "plugin-status"
description: "COMPILED-IN charly COMMAND-class plugin that OWNS the externalized `charly status` CLI — the runtime-status surface (table / detail / JSON, --all, --nested)."
---
...
| **Source** | `github.com/opencharly/charly/candy/plugin-status` |
...
See also the [candy reference](/reference/candy/plugin-status/) for this candy's install surface.
