...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-unix-group:v2026.237.1430/plugin-unix-group/) for this candy's install surface.
