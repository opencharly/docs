...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-step:v2026.237.1421/plugin-example-step/) for this candy's install surface.
