...
| **Source** | `github.com/opencharly/plugin-file/candy/plugin-file` |
...
#FileInput: {
	...
	link_target?: #FileContains @go(LinkTarget)
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-file:v2026.242.2145/plugin-file/) for this candy's install surface.
