...
| **Source** | `github.com/opencharly/plugin-builder-aur/candy/plugin-builder-aur` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-builder-aur:v2026.237.1415/plugin-builder-aur/) for this candy's install surface.
