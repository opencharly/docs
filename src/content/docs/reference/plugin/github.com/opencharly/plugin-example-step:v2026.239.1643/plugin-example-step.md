...
| **Source** | `github.com/opencharly/plugin-example-step/candy/plugin-example-step` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-step:v2026.239.1643/plugin-example-step/) for this candy's install surface.
