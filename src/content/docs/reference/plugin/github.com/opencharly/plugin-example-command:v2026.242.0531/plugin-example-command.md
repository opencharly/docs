...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-command:v2026.242.0531/plugin-example-command/) for this candy's install surface.
