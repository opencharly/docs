...
| **Source** | `github.com/opencharly/plugin-service/candy/plugin-service` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-service:v2026.242.2146/plugin-service/) for this candy's install surface.
