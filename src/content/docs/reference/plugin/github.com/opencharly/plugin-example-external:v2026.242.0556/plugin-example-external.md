...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-external:v2026.242.0556/plugin-example-external/) for this candy's install surface.
