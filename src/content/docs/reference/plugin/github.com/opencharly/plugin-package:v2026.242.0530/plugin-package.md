...
| **Source** | `github.com/opencharly/plugin-package/candy/plugin-package` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-package:v2026.242.0530/plugin-package/) for this candy's install surface.
