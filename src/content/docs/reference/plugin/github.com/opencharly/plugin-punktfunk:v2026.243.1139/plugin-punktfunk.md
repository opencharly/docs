...
| **Source** | `github.com/opencharly/plugin-punktfunk/candy/plugin-punktfunk` |
| **Version** | `2026.243.0549` |
| **Candy** | `plugin-punktfunk` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-punktfunk:v2026.243.1139/plugin-punktfunk/) for this candy's install surface.
