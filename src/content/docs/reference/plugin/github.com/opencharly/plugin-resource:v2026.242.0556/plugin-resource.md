...
| **Source** | `github.com/opencharly/plugin-resource/candy/plugin-resource` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-resource:v2026.242.0556/plugin-resource/) for this candy's install surface.
