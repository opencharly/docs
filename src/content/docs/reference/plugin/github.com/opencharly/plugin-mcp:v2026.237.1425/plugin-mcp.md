...
| **Source** | `github.com/opencharly/plugin-mcp/candy/plugin-mcp` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-mcp:v2026.237.1425/plugin-mcp/) for this candy's install surface.
