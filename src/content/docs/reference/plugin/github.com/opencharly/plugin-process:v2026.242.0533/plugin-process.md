...
| **Source** | `github.com/opencharly/plugin-process/candy/plugin-process` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-process:v2026.242.0533/plugin-process/) for this candy's install surface.
