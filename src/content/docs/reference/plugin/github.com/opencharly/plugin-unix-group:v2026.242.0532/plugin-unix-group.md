...
| **Source** | `github.com/opencharly/plugin-unix-group/candy/plugin-unix-group` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-unix-group:v2026.242.0532/plugin-unix-group/) for this candy's install surface.
