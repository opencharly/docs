...
| **Source** | `github.com/opencharly/plugin-command/candy/plugin-command` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-command:v2026.242.0527/plugin-command/) for this candy's install surface.
