...
| **Source** | `github.com/opencharly/plugin-authoring/candy/plugin-authoring` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-authoring:v2026.242.0525/plugin-authoring/) for this candy's install surface.
