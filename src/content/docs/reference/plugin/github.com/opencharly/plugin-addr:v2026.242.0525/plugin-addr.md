...
| **Source** | `github.com/opencharly/plugin-addr/candy/plugin-addr` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-addr:v2026.242.0525/plugin-addr/) for this candy's install surface.
