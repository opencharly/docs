...
| **Source** | `github.com/opencharly/plugin-example-deploy/candy/plugin-example-deploy` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-deploy:v2026.237.1420/plugin-example-deploy/) for this candy's install surface.
