...
| **Source** | `github.com/opencharly/plugin-migrate/candy/plugin-migrate` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-migrate:v2026.242.0530/plugin-migrate/) for this candy's install surface.
