...
| **Source** | `github.com/opencharly/plugin-matching/candy/plugin-matching` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-matching:v2026.242.0529/plugin-matching/) for this candy's install surface.
