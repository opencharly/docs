...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-examplerunverb:v2026.237.1421/plugin-examplerunverb/) for this candy's install surface.
