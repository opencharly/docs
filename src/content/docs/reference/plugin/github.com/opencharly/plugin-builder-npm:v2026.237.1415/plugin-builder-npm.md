...
| **Source** | `github.com/opencharly/plugin-builder-npm/candy/plugin-builder-npm` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-builder-npm:v2026.237.1415/plugin-builder-npm/) for this candy's install surface.
