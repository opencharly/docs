...
| **Source** | `github.com/opencharly/plugin-example-external/candy/plugin-example-external` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-external:v2026.237.1420/plugin-example-external/) for this candy's install surface.
