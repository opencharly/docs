...
| **Source** | `github.com/opencharly/plugin-sidecar/candy/plugin-sidecar` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-sidecar:v2026.242.0532/plugin-sidecar/) for this candy's install surface.
