...
| **Source** | `github.com/opencharly/plugin-gpu/candy/plugin-gpu` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-gpu:v2026.242.0529/plugin-gpu/) for this candy's install surface.
