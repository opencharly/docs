...
| **Source** | `github.com/opencharly/plugin-dns/candy/plugin-dns` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-dns:v2026.242.0528/plugin-dns/) for this candy's install surface.
