...
| **Source** | `github.com/opencharly/plugin-interface/candy/plugin-interface` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-interface:v2026.242.0530/plugin-interface/) for this candy's install surface.
