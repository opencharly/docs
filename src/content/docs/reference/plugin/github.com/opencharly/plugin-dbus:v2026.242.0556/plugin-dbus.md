...
| **Source** | `github.com/opencharly/plugin-dbus/candy/plugin-dbus` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-dbus:v2026.242.0556/plugin-dbus/) for this candy's install surface.
