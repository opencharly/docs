...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-stepkind:v2026.239.1641/plugin-example-stepkind/) for this candy's install surface.
