...
| **Source** | `github.com/opencharly/plugin-example-structkind/candy/plugin-example-structkind` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-structkind:v2026.237.1422/plugin-example-structkind/) for this candy's install surface.
