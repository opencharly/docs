...
| **Source** | `github.com/opencharly/plugin-builder/candy/plugin-builder` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-builder:v2026.242.0526/plugin-builder/) for this candy's install surface.
