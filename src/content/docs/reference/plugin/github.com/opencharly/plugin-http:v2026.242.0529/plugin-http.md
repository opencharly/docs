...
| **Source** | `github.com/opencharly/plugin-http/candy/plugin-http` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-http:v2026.242.0529/plugin-http/) for this candy's install surface.
