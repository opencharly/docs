...
| **Source** | `github.com/opencharly/plugin-example-command/candy/plugin-example-command` |
...
See also the [candy reference](/reference/candy/github.com/opencharly/plugin-example-command:v2026.237.1420/plugin-example-command/) for this candy's install surface.
