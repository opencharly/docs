...
| **Source** | `github.com/opencharly/charly/candy/plugin-unix-group` |
| **Version** | `2026.176.2600` |
| **Candy** | `plugin-unix-group` |
...
See also the [candy reference](/reference/candy/plugin-unix-group/) for this candy's install surface.
