...
| **Source** | `github.com/opencharly/charly/candy/plugin-harness-kind` |
...
See also the [candy reference](/reference/candy/plugin-harness-kind/) for this candy's install surface.
