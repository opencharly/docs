...
| **Source** | `github.com/opencharly/charly/candy/plugin-agent-pi` |
...
See also the [candy reference](/reference/candy/plugin-agent-pi/) for this candy's install surface.
