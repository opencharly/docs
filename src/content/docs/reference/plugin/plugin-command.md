...
| **Source** | `github.com/opencharly/charly/candy/plugin-command` |
| **Version** | `2026.176.2800` |
| **Candy** | `plugin-command` |
...
See also the [candy reference](/reference/candy/plugin-command/) for this candy's install surface.
